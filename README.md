...
Current verified default on the test Mac is Android Emulator 36.5.11 with `-gpu swangle`, 6144 MB RAM, 4 cores, 30 FPS, host VPN kept running, localhost-only guest hosts, and `version.db` guarded at type0=55/type1=8.

This repository does not include game APKs, game resources, emulator disk images, account data, passwords, screenshots, or logs.
